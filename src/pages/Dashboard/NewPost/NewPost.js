...
const NewPost = () => {
    ...
    const { mutateAsync } = useMutation('create-post', createPost, {
        onSuccess: () => {
            cache.invalidateQueries('posts');
            cogoToast.success('Post has been published');
        },
        onError: (error) => {
    ...
    return (
        <DashboardLayout>
            <div>
                <h3 className='text-3xl'>Add a new post</h3>

                <form id='post_form' onSubmit={handlePostSubmit} encType='multipart/form-data' className='bg-white p-9 w-full mt-10'>
                    <div className='flex flex-col mt-6'>
                        <label>Post Title</label>
                        <input type="text" onChange={handleTitle} className='bg-gray-100 py-3 rounded-md mt-2 focus:outline-none pl-6' required />
                    </div>
                    ...
                    <div className='flex flex-col mt-6'>
                        ...
                        <Editor 
                            ...
                            initialValue='<p>Blog Description will be here....</p>'
                            init={{
                                height: 500
                            }}
                        />
                    ...
                    <button type='submit' className='bg-blue-600 text-white mt-6 py-3 w-full hover:bg-blue-700 transition'>Publish Post</button>
